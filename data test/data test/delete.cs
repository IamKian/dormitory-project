...
public static class DeleteOperations
{
    ...
    public static void DeleteStudent(DormitoryContext context, string identifier)
    {
        ...
        {
            Console.WriteLine("Student has tools assigned.");
            return;
        }
    ...
    public static void DeleteSupervisor(DormitoryContext context, string phoneNumber)
    {
        var supervisor = context.Supervisors.FirstOrDefault(s => s.PhoneNumber == phoneNumber);
        if (supervisor == null)
        {
